...
LOCALIZATION = {
    'en': {
        ...
        'cs2_pistols': 'Pistols',
        'cs2_smgs': 'SMGs',
        'cs2_shotguns': 'Shotguns',
        'cs2_machine_guns': 'Machine Guns',
        'cs2_stickers': 'Stickers',
        'cs2_agents': 'Agents',
        'cs2_patches': 'Patches',
        
        # CS2 Main Categories
        'cs2_category_weapons': '🔫 Weapons',
        'cs2_category_other': '🎨 Other Items',
        
        # CS2 Weapon Categories
        'cs2_weapons_knives': '🔪 Knives',
        'cs2_weapons_gloves': '🧤 Gloves',
        'cs2_weapons_pistols': '🔫 Pistols',
        'cs2_weapons_smgs': '⚡ SMGs',
        'cs2_weapons_rifles': '🎯 Rifles',
        'cs2_weapons_shotguns': '💥 Shotguns',
        'cs2_weapons_machine_guns': '🔥 Machine Guns',
        'cs2_weapons_snipers': '🎯 Sniper Rifles',
        
        # CS2 Souvenir
        'cs2_souvenir_question': '🎁 *Souvenir Item?*\n\nIs this a souvenir item?',
        'cs2_souvenir_yes': '✅ Yes (Souvenir)',
        'cs2_souvenir_no': '❌ No (Regular)',
        
        # CS2 Quality (Rarity)
        'cs2_select_quality': '💎 *Select Quality/Rarity*\n\nChoose the item quality:',
        'cs2_quality_consumer': '⚪ Consumer Grade',
        'cs2_quality_industrial': '🔵 Industrial Grade',
        'cs2_quality_milspec': '🔷 Mil-Spec',
        'cs2_quality_restricted': '🟣 Restricted',
        'cs2_quality_classified': '🌸 Classified',
        'cs2_quality_covert': '❤️ Covert',
        'cs2_quality_contraband': '🟡 Contraband',
        
        # CS2 Wear Conditions
        'cs2_select_wear': '🔧 *Select Wear Condition*\n\nChoose the item condition:',
        'cs2_wear_fn': '✨ Factory New (0.00-0.07)',
        'cs2_wear_mw': '🌟 Minimal Wear (0.07-0.15)',
        'cs2_wear_ft': '⭐ Field-Tested (0.15-0.37)',
        'cs2_wear_ww': '💫 Well-Worn (0.37-0.45)',
        'cs2_wear_bs': '🌑 Battle-Scarred (0.45-1.00)',
        
        # CS2 Models - Knives
        'cs2_select_model': '🔪 *Select {category}*\n\nChoose the model:',
        'cs2_knife_karambit': 'Karambit',
        'cs2_knife_m9': 'M9 Bayonet',
        'cs2_knife_bayonet': 'Bayonet',
        'cs2_knife_butterfly': 'Butterfly Knife',
        'cs2_knife_flip': 'Flip Knife',
        'cs2_knife_gut': 'Gut Knife',
        'cs2_knife_huntsman': 'Huntsman Knife',
        'cs2_knife_falchion': 'Falchion Knife',
        'cs2_knife_bowie': 'Bowie Knife',
        'cs2_knife_daggers': 'Shadow Daggers',
        'cs2_knife_ursus': 'Ursus Knife',
        'cs2_knife_navaja': 'Navaja Knife',
        'cs2_knife_stiletto': 'Stiletto Knife',
        'cs2_knife_talon': 'Talon Knife',
        'cs2_knife_classic': 'Classic Knife',
        'cs2_knife_paracord': 'Paracord Knife',
        'cs2_knife_survival': 'Survival Knife',
        'cs2_knife_nomad': 'Nomad Knife',
        'cs2_knife_skeleton': 'Skeleton Knife',
        
        # CS2 Models - Gloves
        'cs2_glove_sport': 'Sport Gloves',
        'cs2_glove_driver': 'Driver Gloves',
        'cs2_glove_hand_wraps': 'Hand Wraps',
        'cs2_glove_moto': 'Moto Gloves',
        'cs2_glove_specialist': 'Specialist Gloves',
        'cs2_glove_bloodhound': 'Bloodhound Gloves',
        'cs2_glove_hydra': 'Hydra Gloves',
        'cs2_glove_broken_fang': 'Broken Fang Gloves',
        
        # CS2 Weapons
        'cs2_weapon_ak47': 'AK-47',
        'cs2_weapon_m4a4': 'M4A4',
        'cs2_weapon_m4a1s': 'M4A1-S',
        'cs2_weapon_awp': 'AWP',
        'cs2_weapon_deagle': 'Desert Eagle',
        'cs2_weapon_glock': 'Glock-18',
        'cs2_weapon_usp': 'USP-S',
        'cs2_weapon_p250': 'P250',
        'cs2_weapon_fiveseven': 'Five-SeveN',
        'cs2_weapon_cz75': 'CZ75-Auto',
        
        # CS2 Price Display
        'cs2_item_details': '💎 *{name}*\n\n🏷️ Quality: {quality}\n🔧 Condition: {wear}\n💰 Price: ${price_usd:.2f} / ₽{price_rub:.2f}\n\n📊 Last Updated: {timestamp}',
        'cs2_price_comparison': '💰 *Price Comparison*\n\n{prices}\n\n📊 Average: ${avg:.2f}\n📈 Best: ${best:.2f} ({best_market})\n📉 Worst: ${worst:.2f} ({worst_market})',
    ...
    'ru': {
        ...
        'cs2_smgs': 'ПП',
        'cs2_shotguns': 'Дробовики',
        'cs2_machine_guns': 'Пулемёты',
        'cs2_stickers': 'Наклейки',
        'cs2_agents': 'Агенты',
        'cs2_patches': 'Патчи',
        
        # CS2 Main Categories
        'cs2_category_weapons': '🔫 Оружие',
        'cs2_category_other': '🎨 Прочее',
        
        # CS2 Weapon Categories
        'cs2_weapons_knives': '🔪 Ножи',
        'cs2_weapons_gloves': '🧤 Перчатки',
        'cs2_weapons_pistols': '🔫 Пистолеты',
        'cs2_weapons_smgs': '⚡ Пистолеты-пулемёты',
        'cs2_weapons_rifles': '🎯 Штурмовые винтовки',
        'cs2_weapons_shotguns': '💥 Дробовики',
        'cs2_weapons_machine_guns': '🔥 Пулемёты',
        'cs2_weapons_snipers': '🎯 Снайперские винтовки',
        
        # CS2 Souvenir
        'cs2_souvenir_question': '🎁 *Сувенирный предмет?*\n\nЭто сувенирный предмет?',
        'cs2_souvenir_yes': '✅ Да (Сувенирный)',
        'cs2_souvenir_no': '❌ Нет (Обычный)',
        
        # CS2 Quality (Rarity)
        'cs2_select_quality': '💎 *Выберите качество*\n\nВыберите качество предмета:',
        'cs2_quality_consumer': '⚪ Ширпотреб',
        'cs2_quality_industrial': '🔵 Промышленное качество',
        'cs2_quality_milspec': '🔷 Армейское качество',
        'cs2_quality_restricted': '🟣 Запрещённое',
        'cs2_quality_classified': '🌸 Засекреченное',
        'cs2_quality_covert': '❤️ Тайное',
        'cs2_quality_contraband': '🟡 Контрабандное',
        
        # CS2 Wear Conditions
        'cs2_select_wear': '🔧 *Выберите состояние износа*\n\nВыберите состояние предмета:',
        'cs2_wear_fn': '✨ Прямо с завода (0.00-0.07)',
        'cs2_wear_mw': '🌟 Немного поношенное (0.07-0.15)',
        'cs2_wear_ft': '⭐ После полевых испытаний (0.15-0.37)',
        'cs2_wear_ww': '💫 Поношенное (0.37-0.45)',
        'cs2_wear_bs': '🌑 Закалённое в боях (0.45-1.00)',
        
        # CS2 Models - Knives
        'cs2_select_model': '🔪 *Выберите {category}*\n\nВыберите модель:',
        'cs2_knife_karambit': 'Керамбит',
        'cs2_knife_m9': 'Штык-нож M9',
        'cs2_knife_bayonet': 'Штык-нож',
        'cs2_knife_butterfly': 'Нож-бабочка',
        'cs2_knife_flip': 'Складной нож',
        'cs2_knife_gut': 'Нож с лезвием-крюком',
        'cs2_knife_huntsman': 'Охотничий нож',
        'cs2_knife_falchion': 'Фальшион',
        'cs2_knife_bowie': 'Нож Боуи',
        'cs2_knife_daggers': 'Теневые кинжалы',
        'cs2_knife_ursus': 'Медвежий нож',
        'cs2_knife_navaja': 'Наваха',
        'cs2_knife_stiletto': 'Стилет',
        'cs2_knife_talon': 'Нож с лезвием-крюком',
        'cs2_knife_classic': 'Классический нож',
        'cs2_knife_paracord': 'Нож с паракордом',
        'cs2_knife_survival': 'Нож выживания',
        'cs2_knife_nomad': 'Кочевой нож',
        'cs2_knife_skeleton': 'Скелетный нож',
        
        # CS2 Models - Gloves
        'cs2_glove_sport': 'Спортивные перчатки',
        'cs2_glove_driver': 'Водительские перчатки',
        'cs2_glove_hand_wraps': 'Бинты',
        'cs2_glove_moto': 'Мотоциклетные перчатки',
        'cs2_glove_specialist': 'Перчатки специалиста',
        'cs2_glove_bloodhound': 'Перчатки ищейки',
        'cs2_glove_hydra': 'Перчатки «Гидра»',
        'cs2_glove_broken_fang': 'Перчатки «Сломанный клык»',
        
        # CS2 Weapons
        'cs2_weapon_ak47': 'АК-47',
        'cs2_weapon_m4a4': 'M4A4',
        'cs2_weapon_m4a1s': 'M4A1-S',
        'cs2_weapon_awp': 'AWP',
        'cs2_weapon_deagle': 'Desert Eagle',
        ...
        # CS2 Price Display
        'cs2_item_details': '💎 *{name}*\n\n🏷️ Качество: {quality}\n🔧 Состояние: {wear}\n💰 Цена: ${price_usd:.2f} / ₽{price_rub:.2f}\n\n📊 Обновлено: {timestamp}',
        'cs2_price_comparison': '💰 *Сравнение цен*\n\n{prices}\n\n📊 Среднее: ${avg:.2f}\n📈 Лучшая: ${best:.2f} ({best_market})\n📉 Худшая: ${worst:.2f} ({worst_market})',
        'cs2_select_item': '🎮 *{category}*\n\nВыберите предмет:',
